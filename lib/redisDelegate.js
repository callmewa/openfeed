...
function incrementLikeCount(postId) {
  console.log("In incrementLikeCount for " + postId);
  Q.ninvoke(client, 'hget', KEYS.POSTS, postId
    ...
    console.trace('incrementLikeCount failed, error=' + error);
  });
}
...
function likePost(postLike, cb){
  ...
  // increment like count of the post. Fire and forget.
  incrementLikeCount(postLike.postId);
}
