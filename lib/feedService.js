...
var Comment = {
  ...
  createComment: function(postId, commentId, message){
    var obj = Object.create(this);
    obj.timeMsCreated = moment().valueOf();
    obj.postId = postId;
    obj.commentId = commentId;
    obj.commentMessage = message;
    return obj;
  }
};
...
FeedService.prototype.likePost = function(postLike, cb) {
  this.emit(Events.likePost, postLike, cb);
};
...
* @param cb
*/
FeedService.prototype.getFeed = function(loadFeedParams, cb){
  this.emit(Events.getFeed, loadFeedParams, cb);
};
